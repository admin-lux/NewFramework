...
package com.newframework.server.network.download;
...
import com.newframework.server.network.http.AsyncHttpClient;
import com.newframework.server.network.http.AsyncHttpResponseHandler;
import com.newframework.server.network.http.BreakpointHttpResponseHandler;
