package com.newframework.server.network.http;
...
public class SyncHttpClient {
    ...
    public SyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        HttpProtocolParams.setUserAgent(httpParams, "91好医生 v" + BuildConfig.VERSION_NAME + " (Android; targetsdkversion " + Build.VERSION.SDK_INT + ";)");
     ...
     *@param entity
     * @param url the URL to send the request to.
     * @param params  @return String
     * @throws HttpException
     */
    public String post(Context mContext, String s, StringEntity entity, String url, RequestParams params) throws HttpException {
...
//
    ...
    */
    ...
    public String put(Context context, String url, RequestParams params, String contentType) throws HttpException {
        return post(context, url, paramsToEntity(params), contentType);
    }
    /**
    ...
    public String put(Context context, String url, HttpEntity entity, String contentType) throws HttpException{
        return sendRequest(httpClient, httpContext, addEntityToRequestBase(new HttpPut(url), entity), contentType, context);
    }
    ...
    public String delete(Context context, String url) throws HttpException{
        ...
        return sendRequest(httpClient, httpContext, delete, null, context);
    }
     ...
     */
    public String delete(Context context, String url, Header[] headers, RequestParams params) throws HttpException{
        HttpDelete httpDelete = new HttpDelete(getUrlWithQueryString(isUrlEncodingEnabled, url, params));
        if (headers != null) httpDelete.setHeaders(headers);
        return sendRequest(httpClient, httpContext, httpDelete, null, context);
    }
